    ...
    {items.map((item, index) => (
      ...
      >
        ...
        <div className="flex-1">
          <span className="text-sm leading-relaxed font-medium text-gray-800">
            {item.title}
          </span>
          {item.poem && (
            <p className="text-xs italic text-gray-500 leading-relaxed mt-2 pl-3 border-l-2 border-gray-200 whitespace-pre-line">
              {item.poem}
            </p>
          )}
        </div>
